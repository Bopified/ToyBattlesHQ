...
#pragma pack(push, 1) 
        struct CdbItemInfo
        {
            ...
            std::array<char, 100> ii_name_option;
            std::array<char, 50> ii_name_time;
            int ii_type;
            int ii_type_inven;
            ...
            int ii_icon;
            int ii_iconsmall;
            std::array<char, 50> ii_meshfilename;
            std::array<char, 50> ii_nodename;
            std::array<char, 50> ii_color_ambient;
            std::array<char, 50> ii_color_diffuse;
            std::array<char, 50> ii_color_specular;
            std::array<char, 50> ii_color_emittance;
            int ii_sfx;
            int ef_effect_1;
            int ef_target_1;
            int ef_effect_2;
